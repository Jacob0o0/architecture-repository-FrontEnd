...
function Espacio() {
  ...
  const handleSubmit = () => {
    ...
    setSuccessMessage('Espacio Urbano subido con éxito.');
  };
      ...
      content: (
        <div className="space-y-4">
          <div className="input_group">
            <label htmlFor="nombre" className="flex">Nombre del Espacio Urbano<span className="text-red-400">*</span>: </label>
            <input 
              className="h-10 border mt-1 rounded px-4 w-full focus:outline-amarilloPrincipal" 
              type="text" 
              placeholder="Nombre del espacio urbano" 
              name="nombre" 
              id="nombre"
        ...
        <div className="flex flex-row justify-around space-x-8">
          <div className="input_group">
            <label htmlFor="genero" className="flex">Género Espacio Urbano <span className="text-red-400">*</span>: </label>
            <select
              className="h-10 border mt-1 rounded px-4 w-full  focus:outline-amarilloPrincipal"
              name="genero"
              id="genero"
...

    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="input_group">
            <label htmlFor="corriente_est" className="flex">Principios de Diseño: </label>
            <textarea 
              className="border mt-1 rounded px-4 w-full focus:outline-amarilloPrincipal" 
              placeholder="Inserte texto aquí..." 
              id="corriente_est" 
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="input_group">
            <label htmlFor="corriente_est" className="flex">Importancia: </label>
            <textarea 
              className="border mt-1 rounded px-4 w-full focus:outline-amarilloPrincipal" 
              placeholder="Inserte texto aquí..." 
              id="corriente_est" 
  ...
  return (
    <div className="w-full min-h-screen mb-10 flex flex-col items-center justify-center space-y-6" id="formulario">
      <div className="w-4/5 flex items-center justify-start">
        <h3 className="text-3xl font-semibold">Añadir Espacio Urbano</h3>
      </div>
